...
def _endpoint(role, db_cfg, meta_cfg, project_id, region, default_endpoint_type="cloud"):
    # role: so / ta
...
def build_payload():
    ...
    source_endpoint = [
        _endpoint("so", src_db, source_meta, src_project, region, default_endpoint_type=src_default_type),
    ]
    target_endpoint = [
        _endpoint("ta", tgt_db, target_meta, tgt_project, region, default_endpoint_type=tgt_default_type),
    ]
