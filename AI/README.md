...
- [Claude Code SDK Agent MaaS Skill](./AI-Coding/Enterprise-MaaS-Foundation/Claude-Code-SDK-Agent-MaaS-Skill/README.md) — Adapt Claude Code or Claude Agent SDK to Huawei Cloud MaaS through a local compatible proxy.
- [Claude Code Huawei MaaS](./AI-Coding/Enterprise-MaaS-Foundation/claude-code-huawei-maas/README.md) — Route Claude Code through `claude-code-router` to Huawei Cloud MaaS with `glm-5.1`.
...
- [LiteLLM SearXNG AICoding Gateway Single ECS](./AI-Coding/Enterprise-MaaS-Foundation/LiteLLM-SearXNG-AICoding-Gateway-Single-ECS/README.md) — Single-host LiteLLM + SearXNG MCP gateway on Huawei Cloud ECS, wired into Claude Code via claude-code-router with `CLAUDE_CONFIG_DIR` isolation.
