...
```text
/root/litellm-maas-plugin/litellm_plugins/cc_glm52_guard/
```
...
```bash
mkdir -p /root/litellm-maas-plugin/litellm_plugins/cc_glm52_guard
...
services:
  litellm:
    volumes:
      - /root/litellm-maas-plugin/litellm_plugins/cc_glm52_guard/callback.py:/app/cc_glm52_guard.py:ro
```
