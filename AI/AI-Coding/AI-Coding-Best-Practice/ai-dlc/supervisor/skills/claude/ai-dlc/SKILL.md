...
name: ai-dlc
description: |
  Spec-driven coding flow: you write the code, the plane validates the
  spec, a human holds the merge gate. Ask `plan.py next` for the next step.
  Use for any change routed through the AI-DLC pipeline.
version: "0.14"
---
