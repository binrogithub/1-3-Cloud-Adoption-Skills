# PRD v3: maas-dreaming E2E Hardening & SKILL.md Completeness
...
**Acceptance criteria:**
- After indexing the maas-dreaming project, `edges` table has > 0 rows
...
**Update "Default `/maas-dreaming` behavior" section** to include:
...
| `edges` table rows (maas-dreaming project) | 0 | > 0 |
