...
the user-visible output of `/maas-dreaming`.
...
- If no: explain that maas-dreaming needs either code or session data
...
**Acceptance:**
- `/maas-dreaming` on a fresh project auto-creates code-index.db
