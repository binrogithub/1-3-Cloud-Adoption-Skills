...
**Acceptance:**
- After indexing maas-dreaming project, `edges` table has > 0 rows
...
**Acceptance:**
- Dream report on maas-dreaming project includes `## Key Symbols` section
- Table has > 0 rows
- Symbols are ordered by total edge count descending

## Definition of Done

- [ ] `edges` table populated after indexing maas-dreaming project
