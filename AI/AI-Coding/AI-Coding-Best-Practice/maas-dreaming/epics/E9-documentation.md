...
- Quick Start: `mce index` → `mce query overview` → `/maas-dreaming`
...
- Commit: `git add .maas-dreaming/code-index.db.zst artifact.json`
...
- Stale data: delete `.maas-dreaming/code-index.db` and re-index
```
