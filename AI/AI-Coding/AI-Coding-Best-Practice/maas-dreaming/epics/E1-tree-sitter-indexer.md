...
**Acceptance:**
- Full index of maas-dreaming itself (66 files) completes in <10 seconds
...
- Creates `.maas-dreaming/` directory if needed
...
- [ ] Index of maas-dreaming repo completes in <10s
