#!/usr/bin/env python3
"""Build a clean maas-dreaming skill bundle."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build a clean maas-dreaming skill bundle.")
    parser.add_argument("--output", default=str(ROOT / "dist" / "maas-dreaming"), help="Bundle output directory.")
