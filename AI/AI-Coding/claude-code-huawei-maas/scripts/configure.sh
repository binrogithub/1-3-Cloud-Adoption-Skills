...
# is set; use the auto-compact window so long sessions compact before the MaaS
# hard input limit instead of overflowing.
export CLAUDE_CODE_AUTO_COMPACT_WINDOW="\${CLAUDE_GLM_AUTO_COMPACT_WINDOW:-$MAAS_CONTEXT_TOKENS}"
