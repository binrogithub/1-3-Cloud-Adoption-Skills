...
- `CLAUDE_CODE_AUTO_COMPACT_WINDOW=120000` only inside the `claude-glm` wrapper (auto-compact trigger window; `CLAUDE_CODE_MAX_CONTEXT_TOKENS` is ignored unless `DISABLE_COMPACT` is set)
