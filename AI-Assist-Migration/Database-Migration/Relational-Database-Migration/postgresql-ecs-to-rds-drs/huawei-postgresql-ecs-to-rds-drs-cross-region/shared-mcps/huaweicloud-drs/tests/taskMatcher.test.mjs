...
describe('taskMatcher - findMatchingTasks', () => {
  it('returns reuse_candidate when exact match exists', () => {
    const tasks = [
      { task_name: 'pg-ecs-to-rds-cross-region', target_region: 'cn-north-4', source_endpoint: '198.51.100.1:5432', source_database: 'demodb', target_database: 'demodb', source_engine: 'PostgreSQL', target_engine: 'PostgreSQL', sync_mode: 'Full + Incremental', network_type: 'Public Network', source_port: 5432, target_rds_id: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa01in03' },
    ];
