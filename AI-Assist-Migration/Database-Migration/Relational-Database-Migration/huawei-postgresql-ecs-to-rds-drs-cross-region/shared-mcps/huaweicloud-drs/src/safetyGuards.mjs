...
export function validateStartConditions({
  ...
  if (source_endpoint && source_endpoint !== '110.238.67.209:5432') {
    blockers.push(`Source endpoint must be 110.238.67.209:5432, got ${source_endpoint}`);
  }
  ...
  if (target_rds_id && target_rds_id !== '82a6795906de4c6db33e1c0e96594840in03') {
    blockers.push(`Target RDS ID must be 82a6795906de4c6db33e1c0e96594840in03, got ${target_rds_id}`);
  }
