...
const TOOL_DEFINITIONS = [
  ...
  {
    name: "create_ticket",
    description: "Create (SUBMIT) a service ticket. WARNING: This creates a REAL ticket. Use prepare_ticket first to review the payload.",
    inputSchema: {
      type: "object",
      properties: {
    ...
    switch (name) {
      ...
      case "prepare_ticket": {
        ...
        const payload = {
          ...
          source_id: session.sourceId || "83aeb0f2834c4df49826c781d32a963e",
